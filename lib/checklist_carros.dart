...
class ChecklistCarrosScreen extends StatefulWidget {
  ...
  static const routeName = '/Checklist_carros';
...
class _ChecklistCarrosScreenState extends State<ChecklistCarrosScreen> {
  ...
  final TextEditingController kmProximaTrocaController = TextEditingController();

  List<ItemChecklist> items = [
    ItemChecklist('Faróis/Lâmpadas/Piscas', 'Verificar condições e funcionamento.'),
    ItemChecklist('Pneus', 'Verificar se estão calibrados e se existe alguma avaria.'),
    ItemChecklist('Para-brisa e limpadores', 'Verificar condições e funcionamento.'),
    ItemChecklist('Retrovisores', 'Verificar condições e funcionamento.'),
    ItemChecklist('Instrumentos e indicadores', 'Verificar no painel os indicadores.'),
    ItemChecklist('Ar-condicionado', 'Verificar condições e funcionamento.'),
    ItemChecklist('Cintos de segurança', 'Verificar condições e funcionamento.'),

...
import 'package:prototipo/add_mobile.dart';
import 'dart:async';
import 'package:prototipo/veiculos_disponiveis.dart';

class ClienteMobilePage extends StatefulWidget {
  const ClienteMobilePage({super.key});

  @override
  _ClienteMobilePageState createState() => _ClienteMobilePageState();
}

class _ClienteMobilePageState extends State<ClienteMobilePage> {
  @override
  void dispose() {
...
class _FancyBottomNavigationState extends State<FancyBottomNavigation> {
  ...
  _FancyBottomNavigationState({
    ...
    this.currentIndex,
    this.activeColor,
    this.inactiveColor = Colors.deepOrange,
    this.backgroundColor,
    this.iconSize,
    required this.onItemSelected,
  }) {

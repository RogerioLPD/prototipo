...
class ChecklistOnibusScreen extends StatefulWidget {
  const ChecklistOnibusScreen({super.key});

  @override
  State<ChecklistOnibusScreen> createState() => _ChecklistOnibusScreenState();
}

class _ChecklistOnibusScreenState extends State<ChecklistOnibusScreen> {
  ...
  List<ItemChecklist> items = [
    ...
    ItemChecklist(
        'Itens de segurança', 'Chave de roda/ Triângulo/ Macaco/ Extintor.'),
  ];
